...
function addSpiral(layer, data) {
  ...
  // (93.2 - 50) / 54
  var numOfPoints = 55;
  var pointDistanceIncrement = (outerR - innerR)/(numOfPoints-1);
  ...
  for (var i = 0; i < numOfPoints; i++) {
    ...
    var pointLength = innerR + i * 0.8; // default was 50.
    ...
    var pointAngle = i * 10;
    pointLength = pointLength + lengthChange;
